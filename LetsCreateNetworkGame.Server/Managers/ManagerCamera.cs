...
namespace LetsCreateNetworkGame.Server.Managers
{
    public class ManagerCamera
    {
        ...
        public Vector2 TilePosition { get { return new Vector2(_position.X/160, _position.Y/90);}}
            ...
            switch (direction)
            {
               case Direction.Left:
                ...
                case Direction.Right:
                    ...
                    break; 
                case Direction.Up:
                    _moveToPosition = new Vector2(_position.X, _position.Y - 90);
                    break; 
        ...
        {
            return ((vector.X > _position.X - 16 && vector.X < _position.X + 800 - 16 ) &&
                    (vector.Y > _position.Y - 16 && vector.Y < _position.Y + 480 - 16 )); 
        }
        ...
        public bool MouseInsideWindow()
        {
            ...
            return pos.X >= 0 && pos.X <= 160 && pos.Y >= 0 && pos.Y <= 90;
        }
    }
}
